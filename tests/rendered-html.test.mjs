...
test("renders the site identity and real blog index", async () => {
  ...
  assert.match(home, /href="\/message"/)
...
test("does not expose the removed now, projects, or uses pages", async () => {
...
test("serves search, feeds, manifests, and crawler metadata", async () => {
  ...
  assert.doesNotMatch(sitemap, /https:\/\/blog\.ruawd\.de\/(?:now|projects|uses)</)
